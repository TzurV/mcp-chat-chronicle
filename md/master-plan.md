...
**WP-5.1.2B Direct FABLE development references.** *(depends WP-5.1.2A; supersedes the unexecuted automated two-teacher corpus design in `md/handoffs/WP-5.1.2-real-data-teacher-reference-corpus.md`)*
